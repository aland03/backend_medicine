...
class FeedbackController {
    getAllFeedback = () => {
        return (req, res) => {
            models.getAllFeedback().then(data => {
                data =
                    res.send(data)
            }).catch((err) => {
                console.log(err)
    ...
    getByIdFeedback = () => {
        return (req, res) => {
            ...
            models.getByIdFeedback(feedbackId).then(data => {
                res.send(data)
            }).catch((err) => {
                console.log(err)
                res.status(403).send({
    ...
    getByPatientId = () => {
        return (req, res) => {
            ...
            models.getByPatientId(patientId).then(data => {
                res.send(data)
            }).catch((err) => {
                console.log(err)
                res.status(403).send({
    ...
    getByAppointmentId = () => {
        return (req, res) => {
            ...
            models.getByAppontmentId(appointmentId).then(data => {
                res.send(data)
            }).catch((err) => {
                console.log(err)
                res.status(403).send({
    ...
    addNewFeedback = () => {
        return (req, res) => {
            ...
            if (validation.addNew(body).error) {
                ...
                models.addNewFeedback(body).then(data => {
                    res.send(data)
                }).catch(err => {
                    console.log(err);
                    res.status(403).send({
    ...
    deleteFeedback = () => {
        return (req, res) => {
            const feedbackId = req.params.feedback_id
            models.deteleFeedback(feedbackId).then(data => {
                res.send(data)
            }).catch((err) => {
                console.log(err)
                res.status(403).send({
    ...
    updateFeedback = () => {
        return (req, res) => {
            ...
            if (validation.updateFeedback(body).error) {
                ...
                models.updateFeedback(feedbackId, body).then(data => {
                    res.send(data)
                }).catch(err => {
                    console.log(err);
                    res.status(403).send({
